...
class IconRotator extends StatefulWidget {
  const IconRotator.InOutRotation({
    Key key,
    this.color,
    this.size = 50.0,
    this.itemBuilder,
  ...
  @override
  _IconRotatorState createState() => _IconRotatorState();
}

class _IconRotatorState extends State<IconRotator> with SingleTickerProviderStateMixin {
  ...
  Widget _itembuilder(int index, double curveValue) => widget.itemBuilder != null
      ...
      : Image.asset("assets/images/Group 61.png", fit: BoxFit.cover
  );
}
